defmodule Stixex.Objects.ThreatActor do
  ...
  def changeset(struct, params) do
    changeset
    |> cast_common(params)
    |> cast(params, [:aliases, :name, :description, :roles, :goals, :sophistication, :resource_level, :primary_motivation, :secondary_motivations, :personal_motivations])
    ...
    |> Stixex.Validation.validate_values_in_vocab(:sophistication, "threat-actor-sophistication-ov")
