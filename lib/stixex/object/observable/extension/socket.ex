defmodule StixEx.Object.Observable.Extension.Socket do
  ...
  def changeset(struct, params) do
    struct
    |> cast(params, [:address_family, :is_blocking, :is_listening, :protocol_family, :options, :socket_type, :socket_descriptor, :socket_handle])
    |> validate_required(@required_fields)
    |> validate_change(:address_family, validate_values_in_enum("network-socket-address-family-enum"))
    |> validate_change(:protocol_family, validate_values_in_enum("network-socket-protocol-family-enum"))
