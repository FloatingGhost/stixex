defmodule Stixex.Object.Observable.Extension.WindowsPEBinary do
  ...
  def changeset(struct, params) do
    struct
    |> cast(params, [:pe_type, :imphash, :machine_hex, :number_of_sections, :time_date_stamp, :pointer_to_symbol_table_hex, :number_of_symbols, :size_of_optional_header, :characteristics_hex, :file_header_hashes])
