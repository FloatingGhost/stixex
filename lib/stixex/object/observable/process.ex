defmodule StixEx.Object.Observable.Process do
  ...
  def changeset(struct, params) do
    struct
    |> cast_common(params)
    |> cast(params, [:is_hidden, :pid, :name, :created, :cwd, :arguments, :command_line, :environment_varaibles, :opened_connection_refs, :creator_user_ref, :binary_ref, :parent_ref, :child_refs])
  end
end
